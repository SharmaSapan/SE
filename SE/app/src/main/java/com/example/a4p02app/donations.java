...
public class donations extends AppCompatActivity {
    ...
    View searchbar;
    ListView dList;
    String[] donoList = {"Donation 1", "Donation 2", "Donation 3", "Donation 4",
            "Donation 5", "Donation 6","Donation 7","Donation 8","Donation 9",
            "Donation 10"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this, R.layout.activity_home_list, R.id.textView_, donoList);
